    ...
    function($,window,document,undefined)
    {
        ...
        $.fn.lazyload=function(options)
        {
            ...
            var settings={
                ...
                container:window,data_attribute:"original",skip_invisible:true,
                ...
                function()
                {
                    ...
                    $self.one("appear",function(){
                        if(!this.loaded)
                        {
                            if(settings.appear)
                            {
                                var elements_left=elements.length;settings.appear.call(self,elements_left,settings)
                            }
...
var Swiper=function(a,b)
{
    ...
    function f()
    {
        function a(a)
        {
            var c=new Image;
            c.onload=function(){
                C&&C.imagesLoaded&&C.imagesLoaded++,C.imagesLoaded===C.imagesToLoad.length&&(C.reInit(),b.onImagesReady&&C.fireCallback(b.onImagesReady,C))},c.src=a
        }
