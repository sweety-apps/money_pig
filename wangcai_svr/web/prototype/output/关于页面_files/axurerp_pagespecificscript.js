...
gv_vAlignTable['u3'] = 'top';gv_vAlignTable['u4'] = 'top';document.getElementById('u5_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('免责声明.html');
