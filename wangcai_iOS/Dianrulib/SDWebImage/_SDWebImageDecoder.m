...
@implementation _SDWebImageDecoder
static _SDWebImageDecoder *sharedInstance;
...
+ (_SDWebImageDecoder *)sharedImageDecoder
{
    if (!sharedInstance)
    {
        sharedInstance = [[_SDWebImageDecoder alloc] init];
    }
