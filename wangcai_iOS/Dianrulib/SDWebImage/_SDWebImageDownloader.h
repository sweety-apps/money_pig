...
extern NSString *const _SDWebImageDownloadStartNotification;
extern NSString *const _SDWebImageDownloadStopNotification;

@interface _SDWebImageDownloader : NSObject
{
    @private
    NSURL *url;
